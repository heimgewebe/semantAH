...
-   **[Feedback Loop](semantAH-feedback-loop.md):** How semantAH provides signals back to the Heimgewebe organism
    and how policies close the self-improvement loop.

Additional runbooks and cross-repo documents live alongside these core docs, e.g.:
-   `docs/runbook.observability.md`, `docs/runbooks/semantics-intake.md`, `docs/x-repo/weltgewebe.md`.
